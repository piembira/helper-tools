...
class SqlFormatter
{
    ...
    public static $backtick_quote_attributes = 'style="color: #3574A9;"';
    ...
    public static $pre_attributes = 'style="color: black; background-color: transparent;"';
